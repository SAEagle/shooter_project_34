...
AShooterProjectile::AShooterProjectile(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
    ...
    //NiagaraExplosionEffect = ObjectInitializer.CreateDefaultSubobject<UNiagaraSystem>(this, TEXT("NiagaraComp"));
...
void AShooterProjectile::PostInitializeComponents()
{
    ...
    //UNiagaraComponent* NiagaraExplosionEffect = UNiagaraFunctionLibrary::SpawnSystemAttached();
...
void AShooterProjectile::OnRep_Exploded()
{
    ...
    if (!GetWorld()->LineTraceSingleByChannel(
            Impact, StartTrace, EndTrace, COLLISION_PROJECTILE, FCollisionQueryParams(SCENE_QUERY_STAT(ProjClient), true, GetInstigator())))
    {
        // failsafe
